...
function Footer() {
  ...
  <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div class="text-center">
      ...
      <a
        href="#"
        class="mt-8 inline-block rounded-full border border-primaryColor px-12 py-3 text-sm font-medium text-primaryColor hover:bg-primaryColor hover:text-white focus:outline-none focus:ring active:bg-black"
      >
        Get Started
      </a>
    </div>
